<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/sewar.png') }}" width="89" alt="CoreUI Logo">
    </a>
    ...
    <button class="navbar-toggler aside-menu-toggler d-md-down-none" type="button" data-toggle="">
        <span class="navbar-toggler-icon"></span>
    </button>
